...
# 3. A Python variable name can only contain alpha-numeric characters and underscores (A-Z,a-z,0-9,and_).
# 4. Variable in Python names are case-sensitive (name,Name,and NAME are three different variables).
# 5. The reserved words(keyywords) in Python cannot be used to name the variable in Python.
