...
print("Both a and b are equal" if a == b else "b is greater than a" if b > a else "a is greater than b")
...
# 4. Prefer the ternary operator for simple conditional assignements.
