...
# It is a non-homogeneous data structure that stores the elements in columns of a single row or multiple rows.
...
# It is also a non-homogeneous data structure that stores the elements in columns of a single row or multiple rows.
# The tuple can be represented by ()
# The tuple allows duplicate elements.
# The tuple can use nested among all.
# Example: (1, 2, 3, 4, 5)
...
# A dictionary is also a non-homogeneous data structure that stores key-calue pairs.
